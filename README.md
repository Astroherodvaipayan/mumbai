...
1. Clone the repository:
    ```bash
    git clone https://github.com/AyushRatan1/Learn-AI-Studio.git
    cd your-repo/
    ```
...
I'd love to hear your feedback! Feel free to log an issue on our [GitHub issues page](https://github.com/AyushRatan1/Learn-AI-Studio.git). If your question is more personal, [Ayush Ratan on LinkedIn](https://www.linkedin.com/in/ayush-ratan/) is always open as well.
